...
const NATIVE_W = 180;
// Must match the finished card size in lib/printSheet.js (FINISHED_W/FINISHED_H, 85x55mm) —
// a mismatch here means the screenshot gets cropped when drawRenderedCardFace "cover"-fits it
// onto the print artboard, cutting into content that looked fine in the web preview.
